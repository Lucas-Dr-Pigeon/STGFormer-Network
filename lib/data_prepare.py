...
import pickle
from .utils1 import adj_reader, shp_and_tmc_reader, feature_reader
...
def load_inrix_data(adj_path,
    ...
    # print (f"-- debug future_seq_len {future_seq_len} --")
    ...
    return train_loader, valid_loader, test_loader, scaler, [adj]

def load_inrix_data_with_details(adj_path,
                        feature_path,
                        shp_path,
                        tmc_path,
                        tod=False,
    ...
    adj = adj_reader(adj_path)
    shp, tmc = shp_and_tmc_reader(shp_path, tmc_path)
    train_loader, valid_loader, test_loader, scaler = feature_reader(  feature_path,
                                                                            batch_size, 
                                                                            history_seq_len, 
                                                                            future_seq_len, 
    ...
    return train_loader, valid_loader, test_loader, scaler, [adj], shp, tmc
