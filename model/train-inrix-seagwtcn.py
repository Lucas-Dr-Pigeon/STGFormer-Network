...
from model.SEAGWTCN import SEAGWTCN
...
def train_one_epoch(
    ...
    for x_batch, y_batch in train_bar:
        ...
        # print (f"--debug output shape {out_batch.shape}, {y_batch.shape} --")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--dataset", type=str, default="SEAGWTCN_INRIX_MANHATTAN")
    ...
    model = partial(SEAGWTCN, num_nodes=num_nodes, adj=adj_mx[0], device=DEVICE)
